...
CREATE TABLE `tb_agent_detail` (
  ...
  `ag_phone` varchar(64) DEFAULT NULL,
  `ag_fax` varchar(64) DEFAULT NULL,
  ...
  `ag_homepage` varchar(64) DEFAULT NULL COMMENT '대행사 홈페이지',
  `ag_charge_name` varchar(64) DEFAULT NULL COMMENT '과금 부과 기관 사용자 명',
  `ag_charge_org` varchar(64) DEFAULT NULL COMMENT '과금 부과 기관',
  `ag_charge_id` char(36) DEFAULT NULL COMMENT '과금 부과 member ID',
  `reg_datetime` datetime NOT NULL COMMENT '등록시각',
  `mod_datetime` datetime NOT NULL COMMENT '변경시각',
...
CREATE TABLE `tb_board` (
  ...
  `bo_include_tail` varchar(255) DEFAULT NULL,
  ...
  `bo_3_subj` varchar(255) DEFAULT NULL,
  `bo_4_subj` varchar(255) DEFAULT NULL,
  `bo_5_subj` varchar(255) DEFAULT NULL,
  `bo_6_subj` varchar(255) DEFAULT NULL,
  `bo_7_subj` varchar(255) DEFAULT NULL,
  `bo_8_subj` varchar(255) DEFAULT NULL,
  `bo_9_subj` varchar(255) DEFAULT NULL,
  `bo_10_subj` varchar(255) DEFAULT NULL,
  `bo_1` varchar(255) DEFAULT NULL,
  `bo_2` varchar(255) DEFAULT NULL,
  `bo_3` varchar(255) DEFAULT NULL,
  `bo_4` varchar(255) DEFAULT NULL,
  `bo_5` varchar(255) DEFAULT NULL,
  `bo_6` varchar(255) DEFAULT NULL,
  `bo_7` varchar(255) DEFAULT NULL,
  `bo_8` varchar(255) DEFAULT NULL,
  `bo_9` varchar(255) DEFAULT NULL,
  `bo_10` varchar(255) DEFAULT NULL,
  `reg_datetime` datetime NOT NULL COMMENT '등록시각',
  `mod_datetime` datetime NOT NULL COMMENT '변경시각',
  PRIMARY KEY (`id`),
...
CREATE TABLE `tb_board_good` (
  ...
  `bg_flag` varchar(255) DEFAULT NULL,
  `reg_datetime` datetime NOT NULL COMMENT '등록시각',
  `mod_datetime` datetime NOT NULL COMMENT '변경시각',
  PRIMARY KEY (`id`),
...
CREATE TABLE `tb_call` (
  `id` char(36) NOT NULL,
  `te_id` varchar(36) NOT NULL,
  `ca_request_id` char(36) NOT NULL,
  `ca_uri` varchar(64) NOT NULL,
  `ca_request_url` varchar(255) NOT NULL,
  `ca_method` varchar(8) NOT NULL,
  `ca_request_body` text ,
  `ca_response_body` text,  
  `reg_datetime` datetime NOT NULL,
  `mod_datetime` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tb_company` (
  ...
  `co_homepage` varchar(64) DEFAULT NULL COMMENT '대행사 홈페이지',
  `reg_datetime` datetime NOT NULL COMMENT '등록시각',
  `mod_datetime` datetime NOT NULL COMMENT '변경시각',
  PRIMARY KEY (`id`),
  KEY `ag_id` (`ag_id`),
...
CREATE TABLE `tb_counter` (
  `id` varchar(36)  NOT NULL,
  `te_id` varchar(16)  DEFAULT NULL COMMENT 'Tenant Id',
  `tr_id` varchar(20)  DEFAULT NULL COMMENT 'Terminal Id',
...
CREATE TABLE `tb_group` (
  ...
  `gr_4_subj` varchar(255) DEFAULT NULL,
  `gr_5_subj` varchar(255) DEFAULT NULL,
  `gr_6_subj` varchar(255) DEFAULT NULL,
  `gr_7_subj` varchar(255) DEFAULT NULL,
  `gr_8_subj` varchar(255) DEFAULT NULL,
  `gr_9_subj` varchar(255) DEFAULT NULL,
  `gr_10_subj` varchar(255) DEFAULT NULL,
  `gr_1` varchar(255) DEFAULT NULL,
  `gr_2` varchar(255) DEFAULT NULL,
  `gr_3` varchar(255) DEFAULT NULL,
  `gr_4` varchar(255) DEFAULT NULL,
  `gr_5` varchar(255) DEFAULT NULL,
  `gr_6` varchar(255) DEFAULT NULL,
  `gr_7` varchar(255) DEFAULT NULL,
  `gr_8` varchar(255) DEFAULT NULL,
  `gr_9` varchar(255) DEFAULT NULL,
  `gr_10` varchar(255) DEFAULT NULL,
  `reg_datetime` datetime NOT NULL COMMENT '등록시각',
  `mod_datetime` datetime NOT NULL COMMENT '변경시각',
  PRIMARY KEY (`id`),
